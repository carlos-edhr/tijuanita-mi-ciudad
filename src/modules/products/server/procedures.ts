  ...
  getOneById: baseProcedure
    ...
    .query(async ({ ctx, input }) => {
      ...
      return {
        ...
        user: product.user as User & { image: Media | null },
        // reviewRating,
  ...
  getMany: baseProcedure
    .input(
      z.object({
        ...
        maxPrice: z.string().nullable().nullable().optional(),
    ...
    .query(async ({ ctx, input }) => {
      ...
      //   //using reverse not_equals logic
      ...
      const data = await ctx.db.find({
        collection: "products",
        depth: 4, //populate category and "image", "tenant" and "tenant.image"
        where,
        sort,
        page: input.cursor,
        limit: input.limit,
      ...
      return {
        ...
        docs: dataWithSummarizedReviews.map((doc) => ({
          ...
          user: doc.user as User & { image: Media | null },
        })),
      };
    }),
});
